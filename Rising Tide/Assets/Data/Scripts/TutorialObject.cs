...
public class TutorialObject : MonoBehaviour {
	...
	public string[] narrText = new string[25];
	public bool[] narrTextTrigger = new bool[25];
	...
	private bool hasLeftCavern = false;
	...
	void Update ()
	{
		if (hasCompletedTutorial) {
			...
			gate.transform.localPosition = new Vector3 (30f, 0, 0);
			...
			inTemple = GameObject.Find ("CavernTemple").GetComponent<LocationTracking> ().here;
			...
			if (inTemple && acceptQuest && !questEightComplete && questSevenComplete) {
				acceptQuest = false;
				questEightComplete = true;
				completeMissionText.SetActive (true);
				returnToBorkText.SetActive (true);
			...
			if (hasLeftCavern && acceptQuest && !questNineComplete && questEightComplete) {
				acceptQuest = false;
				questNineComplete = true;
				completeMissionText.SetActive (true);
				returnToBorkText.SetActive (true);
	...
	void fillNarrativeString(){
		...
		narrText [17] = "Bork: Hmm, well this is an incredibly bland cave... there must be a way out. [E]";
		narrText [18] = "Bork: Ah... someone precariously built a hole in the ceiling! [E]";
		narrText [19] = "Bork: However, please be careful of the fish in this ocean, I'm still attached to you and I'd rather you not be the last thing I see in this world. [E]";
